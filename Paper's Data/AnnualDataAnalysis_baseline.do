*This runs the regressions for Tables 3-8 and 11-12 for the baseline IV regressions(Row 2 in these tables).  It calls the data file AnnualData_ShortSample.dta, and outputs
*to the log file AnnualDataAnalysis_baseline.log. The coefficients on vfst (or vfstl) are presented in the tables.
...
log using AnnualDataAnalysis_baseline.log, replace
